...
$columns = array_merge(
    ['klijent_id', 'opis', 'reg_oznaka', 'status_izvrsenja', 'poslato', 'created_at', 'punomoc', 'punomoc_extension', 'emin_procena', 'emin_procena_extension'],
...
$values = array_merge(
    [$klijent_id, $opis, $reg_oznaka, $status, $poslato, $created_at, $punomoc, $punomoc_extension, $emin_procena, $emin_procena_extension],
