        ...
        <table>
            ...
            <tr style="border: 1px solid black;">
                <td colspan="2" style=" padding-top: 10px; padding-bottom: 10px; border: 1px solid black;">
                    ...
                    <span style="font-weight: bold; text-align: left; display: inline-block; width: 150px;">'. $datum_nezgode .' </span>
                    u mestu:
            ...
            <tr>
              ...
              <tr>
                <td colspan="2">
                    ...
                    <span style="padding: 2px 5px; border: 1px solid black">
                    ' . (($tip_prijave == '1') ? 'X' : '0') . '
