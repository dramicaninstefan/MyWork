...
<div class="container mt-5">
    <h2 class="mb-4">Kalkulacija šteta</h2>
    ...
    <form class="d-inline" action="../damage/kalkulacija_export_excel.php" method="post" id="exportDamageForm">
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
            data-bs-target="#confirmDownloadKalkSteteModal">
            Exportuj sve podatke <i class="bi bi-file-earmark-arrow-down"></i>
        </button>
    </form>
...
<?php require './modal/import_kalkulacija_cvs.php'; ?>

<!-- Modal za potvrdu preuzimanja -->
<div class="modal fade" id="confirmDownloadKalkSteteModal" tabindex="-1"
