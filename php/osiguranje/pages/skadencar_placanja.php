...
<div class="container-fluid mt-5">
    ...
    <div class="sticky-top py-4 modal-custom" style="z-index: 1010; top: 56px;">
    ...
    <table class="table table-bordered" id="skadencarPlacanjeTable">
        <thead class="table-dark sticky-top" style="top: 190px; z-index: 1020;">
            <tr>
                ...
                <th style="width: 140px;">Procenat (8%)</th>
        ...
        <tbody>
            ...
            <tr class="<?php echo $klasa_reda?>"
                ...
                <td><?php echo number_format($row['premija_bez_poreza'] * 0.08, 2); ?></td>
                <td>
                    <?php 
