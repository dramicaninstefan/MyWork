...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT k.ime_prezime, ks.osig_kuca_stetnik, ks.reg_oznaka
            FROM klijent k
    ...
    if ($result->num_rows > 0) {
        ...
        $reg_oznaka_osteceni = $row['reg_oznaka'];
    } else {
...
<div class="container mt-5">
    ...
    <form id="stetaForm" action="../damage/kreiraj_odstetni_zahtev_m.php" method="POST"
        class="needs-validation mb-5 no-loader" novalidate>
        <div class="sticky-top pt-4 modal-custom">
            <div style="text-align: center;">
                <h2 class="pb-2 text-uppercase">Odštetni zahtev (materijalna)</h2>
            </div>
        ...
        <div class="mb-2">
            <div class="form-floating mb-4 ">
                <input type="text" class="form-control" id="klijentIme" placeholder=""
            ...
            <div class="col-6">
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="registraciona_oznaka" name="registraciona_oznaka"
                        placeholder="Registraciona oznaka" autocomplete="off" readonly
                        value="<?php echo $reg_oznaka_osteceni?>">
