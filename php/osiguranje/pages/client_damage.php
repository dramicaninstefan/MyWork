      ...
      <tr>
        ...
        <td class="d-flex justify-content-between gy-5">
          <form action="/client_damage_files" method="post">
            ...
            <input type="hidden" name="klijent_id" value="<?php echo htmlspecialchars($row['klijent_id']); ?>">
        ...
        <div class="modal-body">
          <form method="POST" action="../damage/add_client_damage.php" enctype="multipart/form-data"
            ...
            <div class="mb-3">
              ...
              <input type="text" id="searchKlijentNew" class="form-control" placeholder="Pretraži klijente..."
                autocomplete="off" required>
            </div>

            <div class="mb-3">
              <select class="form-select" name="klijent_id" id="klijentNew" required size="5" style="display: none;">
                <?php
                            include('config.php');
              ...
              <div class="form-group">
                ...
                <!-- Pretraga klijenata i Select sa filtriranjem -->
                <div class="mb-3">
                  <input type="text" id="searchKlijent2" class="form-control" placeholder="Pretraži klijente..."
                    autocomplete="off" required>
                </div>

                <div class="mb-3">
                  <select class="form-select" name="klijent_id2" id="klijent2" required size="5" style="display: none;">
                    <?php
            include('config.php');
            ...
            ?>
                ...
                document.getElementById('searchKlijent2').addEventListener('focus', function() {
                  document.getElementById('klijent2').style.display = 'block'; // Prikazati select
                });

                // Filtriranje opcija u select-u dok korisnik unosi tekst
                document.getElementById('searchKlijent2').addEventListener('keyup', function() {
                  let filter = this.value.toLowerCase();
                  let options = document.querySelectorAll("#klijent2 option");
                ...
                document.addEventListener('click', function(e) {
                  let select = document.getElementById('klijent2');
                ...
                document.getElementById('klijent2').addEventListener('change', function() {
                  let selectedOption = this.options[this.selectedIndex];
                  let searchInput = document.getElementById('searchKlijent2');
                  ...
                  document.getElementById('klijent2').style.display = 'none';
                });
                </script>
              </div>
