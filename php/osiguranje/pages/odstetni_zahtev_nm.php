...
<div class="container mt-5">
    ...
    <form id="stetaForm" action="../damage/kreiraj_odstetni_zahtev_nm.php" method="POST" class="needs-validation mb-5"
        novalidate>
        ...
        <div class="mb-2">
            <div class="form-floating mb-2 ">
                <input type="text" class="form-control" id="klijentIme" placeholder="Ime i prezime"
        ...
        <div class="form-floating mb-4">
            <input type="text" class="form-control" id="svojstvo" name="svojstvo" placeholder="Svojstvo"
                autocomplete="off" required>
            <label for="svojstvo">Svojstvo</label>
        </div>
            ...
            <div class="col-6">
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="ime_prezime_stetnik" name="ime_prezime_stetnik"
                        placeholder="Ime i prezime / Naziv firme" autocomplete="off">
            ...
            <div class="col-6">
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="marka_tip_vozila_stetnik"
                        name="marka_tip_vozila_stetnik" placeholder="Marka i tip vozila" autocomplete="off">
        ...
        <div class="form-floating mb-2">
            <input type="text" class="form-control" id="dusevna_bol" name="dusevna_bol" oninput="formatirajIznos(this)"
                placeholder="Iznos za naplatu">
            <label for="dusevna_bol">Na ime pretrpljenih duševnih bolova zbog UŽA</label>
        </div>

        <div class="form-floating mb-2">
            <input type="text" class="form-control" id="fizicka_bol" name="fizicka_bol" oninput="formatirajIznos(this)"
                placeholder="Iznos za naplatu">
            <label for="fizicka_bol">Na ime pretrpljenih fizičkih bolova</label>
        </div>

        <div class="form-floating mb-2">
            <input type="text" class="form-control" id="naruzenost" name="naruzenost" oninput="formatirajIznos(this)"
                placeholder="Iznos za naplatu">
            <label for="naruzenost">Na ime naruženosti</label>
        </div>

        <div class="form-floating mb-2">
            <input type="text" class="form-control" id="pretrpljen_strah" name="pretrpljen_strah"
                oninput="formatirajIznos(this)" placeholder="Iznos za naplatu">
            <label for="pretrpljen_strah">Na ime pretrpljenog straha</label>
        </div>

        <div class="form-floating mb-2">
            <input type="text" class="form-control" id="sluz_beleska" name="sluz_beleska"
                oninput="formatirajIznos(this)" placeholder="Iznos za naplatu">
            <label for="sluz_beleska">Na ime troškova pribavljanja službene beleške</label>
        </div>
