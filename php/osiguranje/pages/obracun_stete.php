...
$sql = "SELECT o.*, k.*, s.osig_kuca_stetnik
    ...
    <table class='table table-bordered' id="obracunTable">
        <thead class='table-dark'>
            <tr>
                ...
                <th>Kontakt</th>
                <th>Osig. kuća</th>
                <th style="width: 120px;">Isplaćeno</th>
                <th style="width: 120px;">Procenat</th>
                <th style="width: 100px;">AT</th>
                <th style="width: 100px;">Emin</th>
                <th style="width: 100px;">Preporučilac</th>
                <th style="width: 100px">Uplatnica</th>
                <!-- <th>Trošak 1</th> -->
                <!-- <th>Trošak 2</th>
                <th>Trošak 3</th> -->
                <th></th>
        ...
        <tbody>
            ...
            <form action="../damage/save_obracun.php" method="POST">
                <tr>
                    <td>
                        <div
                            class="<?php echo $total < 0 || $total == 0 ? 'status-red-white' : 'status-green-white'; ?>">
                    ...
                    <td><input type="number" name="preporucilac" value="<?php echo $row["preporucilac"]; ?>"
