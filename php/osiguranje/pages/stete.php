...
// Izvlačenje podataka
$query = "SELECT t.id, t.klijent_id, k.ime_prezime, k.kontakt, t.preporucilac, t.status_izvrsenja, t.poslato, t.created_at, t.emin_procena_status, t.punomoc_status, t.sluzbena_beleska_poslata, t.sluzbena_beleska_status, t.odstetni_zahtev_status
    ...
    <table class="table table-bordered" id="steteTable">
        <thead class="table-dark">
            <tr>
                ...
                <th style="width: 80px; text-align: center;">Procena</th>
                <th style="width: 80px; text-align: center;">MUP</th>
                <th style="width: 80px; text-align: center;">OZ</th>
                <th></th>
                <!-- <th style="width: 180px">Vreme slanja</th> -->
                <th style="width: 100px; text-align: center;">Kreirano</th>
                <th style="width: 150px">Preporučilac</th>
        ...
        <tbody>
            ...
            <tr>
                        ...
                        <div class="dropdown mx-2">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="px-1 mt-2">
                                    <?php
                                    // Provera statusa i postavljanje disabled atributa ako neka vrednost nije 1
                                    $disabled = ($row['sluzbena_beleska_poslata'] == 1 || $row['sluzbena_beleska_status'] == 1) ? 'disabled' : '';
                                    ?>
                ...
                <td><?php echo htmlspecialchars($row['preporucilac']); ?></td>
                <td>
                    <?php
                    ...
                    <form method="POST" action="../damage/add_client_damage.php" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="accordion my-5" id="fileAccordion">
                                ...
                                <div class="row">
                                    <!-- Input za sluzbena_beleska odmah ispod h5 -->
                                    <div class="col-6 mb-3">
                                        <label for="emin_procena" class="form-label">Zakači fajl
                                            emin_procena:</label>
