...
<div class="modal fade" id="csvKlijentiModal" tabindex="-1" aria-labelledby="csvKlijentiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="csvKlijentiModalLabel">Upload CSV fajla</h5>
            ...
            <div class="modal-body">
                ...
                <form action="../client/klijenti_import_csv.php" method="POST" enctype="multipart/form-data"
                ...
                <p class="mt-3">Exel šablon: <a href="../client/podaci_za_bazu_klijenti.xlsx" download>Preuzmi </a></p>
            </div>
        </div>
    </div>
</div>