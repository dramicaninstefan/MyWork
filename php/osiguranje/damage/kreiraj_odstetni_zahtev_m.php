       ...
       <table>
           ...
           <tr>
               <td style="width: 50%; text-align: left;">
                   <br>
                   Na ime štete na vozilu po proceni ' . ( (!$iznos_za_naplatu) ? '' : 'sudskog veštaka:') . ' <br>
                    ' . ((!$iznos_za_naplatu) ? '' : 'Na ime materijalne štete za troškove procenitelja <br>') . '
                   Na ime advokatskih troškova po A.T.
               </td>
               <td style="width: 50%; text-align: right;">
                   <br>
                   ' . ((!$iznos_za_naplatu) ? '' : $iznos_za_naplatu . ' RSD') . '
                    <br>
                    ' . ((!$iznos_za_naplatu) ? '' : '10.000,00 RSD <br>') . '
                   13.500,00 RSD
               </td>
           </tr>
           <tr>
