...
$fileNames = [
    ...
    'stetnik_polisa', 'evropski_izvestaj', 'emin_procena', 'dodatni_dokument1', 'dodatni_dokument2', 'dodatni_dokument3',
...
$columns = array_merge(
    ['klijent_id', 'opis', 'status_izvrsenja', 'poslato', 'created_at', 'punomoc', 'punomoc_extension'],
...
$values = array_merge(
    [$klijent_id, $opis, $status, $poslato, $created_at, $punomoc, $punomoc_extension],
