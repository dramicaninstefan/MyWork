...
$columns = array_merge(
    ['klijent_id', 'opis', 'status_izvrsenja', 'poslato', 'created_at', 'punomoc', 'punomoc_extension', 'emin_procena', 'emin_procena_extension'],
...
$values = array_merge(
    [$klijent_id, $opis, $status, $poslato, $created_at, $punomoc, $punomoc_extension, $emin_procena, $emin_procena_extension],
