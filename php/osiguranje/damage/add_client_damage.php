...
$columns = array_merge(
    ['klijent_id', 'opis', 'preporucilac', 'reg_oznaka', 'osig_kuca_stetnik', 'status_izvrsenja', 'poslato', 'created_at', 'punomoc', 'punomoc_extension', 'sluzbena_beleska', 'sluzbena_beleska_extension', 'emin_procena', 'emin_procena_extension'],
...
$values = array_merge(
    [$klijent_id, $opis, $preporucilac, $reg_oznaka, $osig_kuca, $status, $poslato, $created_at, $punomoc, $punomoc_extension, $sluzbena_beleska, $sluzbena_beleska_extension, $emin_procena, $emin_procena_extension],
