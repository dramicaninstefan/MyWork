...
if (isset($_POST['klijent_id'])) {
    ...
    if ($procenat !== NULL || $dinara !== NULL) {
        // SQL upit za ažuriranje
        $sql = "UPDATE klijent SET punomoc_procenat = ?, punomoc_dinara = ? WHERE id = ?";

        // Priprema upita
        $stmt = $conn->prepare($sql);

        // Bind parametara (double za procenat i dinare, int za ID)
        $stmt->bind_param("ddi", $procenat, $dinara, $klijent_id);
        ...
        <table>
            <tr>
                <td colspan="2" class="title"
                    ...
                    <img src="data:image/png;base64,' . $imgData . '" style="width: 150px; height: 150px;"/>
                </td>
            </tr>
            <tr>
                <td colspan="2" class="title"
                    style="text-align: center; font-weight: bold; padding-bottom: 40px;">
                    <br>
                    <br>
            ...
            <tr>
                <td colspan="2">
                    ...
                    iz <span style="text-align: center; border-bottom: 1px solid black; padding-top: 5px;  display: inline-block; width: 130px;">' . $mesto . ' </span> 
                    JMBG: <span style="text-align: center; border-bottom: 1px solid black; padding-top: 5px;  display: inline-block; width: 150px;">' . $jmbg . ' </span>  
            ...
            <tr>
                <td colspan="2">
                    ...
                    isplate na račun punomoćnika advokata br. 265-1780310001729-95 koji se vodi kod Raiffeisen bank ad
                    Beograd.
                    <br>
                    <br>
                </td>
            ...
            <tr>
                <td colspan="2">
                    U slucaju potrebe ovo punomoćje, imenovani može preneti na drugog advokata ili advokatske
                    pripravnike.
                    <br>
                    <br>
                </td>
            ...
            <tr>
                <td style="vertical-align: top;">U Beogradu, dana: <span
                        style="text-align: center; border-bottom: 1px solid black; padding-top: 5px; padding-botton: 5px;  display: inline-block; width: 100px;">
                        ' . $created_at . ' </span>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    ...
                    ul. <span
                        ...
                        ' . $adresa . ' </span>
                    <br> Grad <span
                        style="text-align: center; border-bottom: 1px solid black; padding-top: 5px;  display: inline-block; width: 180px;">
                        ' . $mesto . ' </span>
                    , MB/PIB <span
                        style="text-align: center; border-bottom: 1px solid black; padding-top: 5px;  display: inline-block; width: 130px;">
                        ' . $jmbg . ' </span>,
                    Tel. <span
            ...
            <tr>
                <td colspan="2">
                    ...
                    <span
                        style="text-align: center; border-bottom: 1px solid black; padding-top: 5px; padding-botton: 5px;  display: inline-block; width:' . ($procenat != 0 ? '60px' : '150px')  . ';">
                        ' . ($procenat != 0 ? $procenat . ' %' : $dinara . ' dinara') . ' </span> koja uključuje i
                    ...
                    <span
                        style="text-align: center; border-bottom: 1px solid black; padding-top: 5px; padding-botton: 5px;  display: inline-block; width:' . ($procenat != 0 ? '60px' : '150px')  . ';">
                        ' . ($procenat != 0 ? $procenat . ' %' : $dinara . ' dinara') . '</span>.
                </td>
            </tr>
