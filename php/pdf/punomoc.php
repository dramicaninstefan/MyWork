...
$slikaPath = 'C:/xampp/htdocs/pdf/slika.jpg'; // Apsolutna putanja do slike
$data = file_get_contents($slikaPath);

if ($data === false) {
    die('Greška prilikom učitavanja slike. Proveri putanju.');
}

$type = pathinfo($slikaPath, PATHINFO_EXTENSION);
                ...
                <table>
                    <tr style="border-bottom: 3px solid lightblue;">
                        <td style="text-align: center;">
                            <img src="./slika.jpg" alt="Logo" style="width: 100px;">
                        </td>
            ...
            <div style="width: 100%; font-size: 13px; font-family: DejaVu Sans, Verdana, Geneva, Tahoma, sans-serif; margin: auto; background: white; line-height: 13px;">
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <br>
                            1. VLASTODAVCA: __________________________, ul. __________________________________
                            Grad _________________, <br> Br.l.k./PIB _________________, Tel. _________________
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <br>
                            2. ADVOKATA: __________________________, ul. __________________________________
                            Grad _________________, <br> PIB _________________, MB _________________
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            naplaćene štete, plati ugovorenu proviziju u visini od _____________ koja uključuje i
...
$dompdf->stream('punomocje.pdf', ['Attachment' => true]);