    ...
    <Fragment>
      ...
      <section className={classes.hero}>
        <div className={classes['hero-content']}>
          ...
          <Link className={classes['hero-content-contact']} to="/kontakt">
      ...
      <main className={classes.main}>
        <div className={classes.info1}>
          ...
          <div className={classes['content']}>
            ...
            <Link className={classes['contact']} to="/kontakt">
              Kontaktirajte nas odmah
            </Link>
          </div>
        </div>
        ...
        <div className={classes.info3}>
          <div className={classes.content}>
            ...
            <p className={classes['content-text']}>
              ...
              osiguranja, Vi prenosite potencijalni, budući i od Vaše volje nezavistan rizik na osiguravajuću kuću, za šta Vi plaćate premiju, u zemenu za eventulnu štetu koju budete imali. Osiguranje
              je značano sa finansijskog stanovišta, jer time štitite svoju finansijsku sigurnost u momentima kada se najmanje nadate, kada se desi štetni događaj. Troškovi u tom momentu mogu da budu
              baš veliki. U tim momentima, osiguranje igra veliku, pa i glavnu ulogu, jer će nadoknaditi štetu koju ste imali, vratiće stvar u prvobitno stanje. Osiguranje je nastalo iz potrebe, ne iz
              nečijeg hira, jer se štetni događaji dešavaju. Zato, nemojte dozvoliti da Vas štetni događaj iznenadi, osigurajte se.
            </p>
          </div>
          <div className={classes.image}>
          ...
          <div className={classes.wrapper}>
            ...
            <div className={classes.content}>
              ...
              <p className={classes['content-text']}>
                ...
                platite kaznu, zbog nastale štete. Ali, ono što najgore može da Vam se desi, da sve to jako utiče na Vaše finansije, a najgori slučaj je kada utiče na vaše najmilije, na Vašu porodicu.
                Vaša porodica postaje ranjiva, vaš biznis može da propadne zbog toga što nemate osiguranje. Sve se ovo može preduprediti polisom osiguranja.
              </p>
            </div>
          </div>
        </div>
        <div className={classes.info5}>
          <div className={classes.content}>
            ...
            <ul className={classes['content-links']}>
              <li>
                <Link to="/">Polisa za Životno Osiguranje</Link>
              </li>
              <li>
                <Link to="/">Polisa za Putno osiguranje</Link>
              </li>
              <li>
                <Link to="/">Polisa za Kasko osiguranje</Link>
              </li>
              <li>
                <Link to="/">Polisa za Osiguranje imovine</Link>
              </li>
              <li>
                <Link to="/">Polisa za Dobrovoljno Zdravstveno Osiguranje</Link>
              </li>
              <li>
                <Link to="/">Polisa za Osiguranje od nezgode</Link>
              </li>
              <li>
                <Link to="/">Polisa za Osiguranje od odgovornosti</Link>
              </li>
            </ul>
          </div>
          <div className={classes.image}>
        ...
        <div className={classes.info7}>
          ...
          <div className={classes.content}>
            ...
            <div className={classes['content-comment']}>
              ...
              <p className={classes.comment}>
                “Želeo sam da osiguram kuću pred polazak na duži put, jer se dešavaju nesreće. Obratio sam se SVEZAOSIGURANJE i oni su me uputili u sve tajne za osiguranje, u sva sitna slova na polisi
                i uslovima. Naravno, imali su najbolju preporuku za moje osiguranje, što sam i uradio.”
              </p>
              <p className={classes.client}>
