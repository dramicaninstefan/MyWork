...
const faq = [
  ...
  },
  {
    ...
    answer:
      'Obavezno pozovite policiju, da napravi zapisnik. Posle toga pozovite nas, da mi sačinimo “zapisnik”, kako bi bili spremni za slučaj kada policija pronađe onog ko Vas je udario (štetnika), jer tada ćemo moći da naplatimo štetu. Inače, ako se ne zna ko Vas je udario, nećete moći da naplatite štetu. U ovim situacijama ne vredi polisa autoodgovornosti (mala polisa za registraciju).',
    show: '',
    collapsed: 'collapsed',
  },
  {
    ...
    answer:
      'Da, imate. Ukoliko se zapisnikom policije utvrdi, da vozilo koje Vas je oštetilo, nije osigurano, u tom slučaju imate pravo naknade štete preko Garantnog fonda pri Udruženju osiguravača Srbije.',
    show: '',
    collapsed: 'collapsed',
  },
  {
    ...
    answer:
      'Za svako drvo u gradu postoji “vlasnik”, koji je dužan da se na pravi način stara o njemu. To staranje podrazumeva, da sva šteta koju to drvo bude napravilo, vlasnik snosi posledice. Tako da, ako Vam je palo drvo, javite se nama, jer mi lako možemo da saznamo ko je “vlasnik” drveta, kome ćemo se obratiti za naknadu štete. A većina vlasnika, ima ugovoreno osiguranje za svoje propuste, i u tom slučaju ćemo naplatu štete raditi od osiguravajuće kuće.',
    show: '',
    collapsed: 'collapsed',
  },
  {
    ...
    answer:
      'Da, imate. Vlasnik pasa je odgovoran za svog psa, za ujed. Tako da, naplata štete od ujeda pasa se vrši od vlasnika. Što se tiče pasa lutalica, “vlasnik” tih pasa je grad. U tom slučaju, obraćamo se gradu za naknadu štete. Naravno, određena procedura se mora ispoštovati. Zato je najbolje, ako Vam se desi takav slučaj, da nas kontaktirate, kako bi Vas tačno uputili šta treba dalje da se radi.',
    show: '',
    collapsed: 'collapsed',
  },
  {
    id: 9,
    question: 'Da li imam pravo da naplatim štetu od predmeta koji je u toku vožnje pao sa drugog vozila?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Da, imate. Osiguravajuća kuća koja je osigurala vozilo, isplatiće štetu koja je načinjena. Pošto je vozač vozila bio u saobraćajnom (zakonskom) prekršaju, osiguravajuća kuća će regresirati (naplatiti) tu isplatu od vozača vozila koje je napravilo štetu.',
    show: '',
    collapsed: 'collapsed',
  },
  {
    ...
    answer:
      'Prvo što treba da uradite, je da se obratite medicinskoj ustanovi, da Vam saniraju povredu, da sačine zapisnik o dešavanju. Nakon toga, obično po službenoj dužnosti, medicinska ustanova je dužna da pozove policiju da oni sačine zapisnik o dešavanju. Na posletku, potrebno je da se javite Veterinarskoj ustanovi koja je zadužena za taj grad, da ih obavestite o dešavanju. Ne posletku je potrebno da imate od svih njih zapisnike, koje ćemo kasnije koristiti kod naplate štete. Naplatu možemo raditi vansudskim postupkom, i ovi postupci se završavaju prilično brzo. Manjkavost ovakvog postupka je nizak iznos koji grad isplaćuje (dobrovoljno)… 10.000 – 30.000 rsd. Nakon ovoga, sudskim putem se mogu potraživati znatno veći iznosi… za lakše povrede do 100.000 rsd, a za veće i preko 200.000 rsd.',
    show: '',
    collapsed: 'collapsed',
  },
  {
