          ...
          <div className="row gy-4">
            ...
            <div className={`${classes.content} col-lg-12 order-1 order-lg-1 mb-4`}>
              ...
              <p>
                ...
                nezgoda. Pored naplate štete nastala na vozilu, moguće je naplatiti štetu i na licima koji su pretrpeli bilo kakvu štetu-povredu u saobraćajnoj nezgodi.
                <br />
                <br />
            ...
            <div className={`${classes.content} col-lg-12 order-1 order-lg-1 mb-4`} id="osnovno">
              <h3 className="pb-4">NAKNADA ŠTETE – KASKO OSIGURANJE</h3>
              <p>
                ...
                <br />
                Neretko je i loša organizacija oko prijave štete od strane oštećenog građanina uzrok za kasnije odbijanje odštetnog zahteva. Zato je dobro, čim Vam se desi ovakav slučaj, da nas
                pozovet da Vas instruišemo šta i kako je potrebno da uradite, da kasnije ne biste imali problema oko naplate štete. Ono što trebate znati u tom slučaju je: <br />
                ...
                mala. Pitanje je: da li je moguće u ovakvim slučajevima naplatiti štetu i kome se obratiti kako biste ostvarili svoja prava? Vlasnik vozila koji ima kasko polisu osiguranje, će bez
                problema naplatiti načinjenu štetu, treba samo da se obrati svojoj osiguravajućoj kući koja će mu isplatiti naknadu za nastalu štetu.
                <br />
                Ukoliko pak nemate kasko, moguće je da naplatite štetu. Neophodno je da pozove policiju pre pomeranja vozila i policija će napraviti zapisnik i naložiti pregledanje snimaka okolnih
                kamera na javnom parkingu. Na osnovu toga bi se utvrdilo koje je vozilo napravilo štetu, a onda bi se vlasnik oštećenog vozila obratio osiguravajućoj kući u kojoj to vozilo ima polisu
            ...
            <div className={`${classes.content} col-lg-12 order-1 order-lg-1 mb-4`} id="delimicno">
              <h3 className="pb-4">OSIGURANJE PUTNIKA U JAVNOM PREVOZU</h3>
              <p>
                Kao putnici u gradskom prevozu znamo da moramo da platimo kartu. <br />
                Ali, da li znate koja su vaša prava u slučaju nezgode u javnom prevozu? <br />
                ...
                osigurane sume i način naplate štete. <br />U slučaju da dođe do nezgode neposredno, građani koji koriste prevoz mogu da zahtevaju naknadu štete na osnovu ugovora o osiguranju.
              </p>
            </div>
