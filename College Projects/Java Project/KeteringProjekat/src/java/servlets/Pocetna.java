...
public class Pocetna extends HttpServlet {  
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("msg", sqle + " ERROR");
        ...
        List<Kategorija> salateKategorije = Kategorija.filterKategorije(kategorije,"salate");
        ...
        request.setAttribute("salateKategorije", salateKategorije);
